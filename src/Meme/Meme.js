...
export const Meme = () => {
    ...
    const generateMeme = () => {
        ...
        formData.append('username', 'AjayPrasad1');
        formData.append('password', 'ZBfVxL!9yak2VgX');
    ...
    return(
        ...
        <div className={styles.container}>
            ...
            <button onClick={() => setMemeIndex(memeIndex - 1) } className={styles.skip} >Back</button>
            {
                captions.map((c, index) =>(
                    <input onChange={(e) => updateCaptions(e, index)} key={index} ></input>
                ))
            }
